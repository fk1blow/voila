    ...
    1: [function(t, e, n) {
        "object" != typeof JSON && (JSON = {}),
            ...
            function() {
                ...
                function u(el, e, n, r) {
                    var listenereFn = Y.addEventListener ? el.addEventListener : Y.attachEvent;

                    Y.addEventListener ? el.addEventListener(e, n, r) : Y.attachEvent ? el.attachEvent("on" + e, function() {
                        var e = K.event;
                        e.currentTarget = el, e.target = e.srcElement, n.call(el, e)
                    }) : el["on" + e] = n
                }
                ...
                function _(t) {
                    ...
                    if (t[0] && e) {
                        var n = e.split("."),
                            r = we + le < (new Date).gt();
                        for (r && (R = 1, n[1] = je(32, 10), n[2] = je(32, 10), Ne(n), T(n[0], n[1], n[2]), B()), we = (new Date).gt(), q(t[0]), H = 1; H < t.length; H++) ! function(t, e) {
                            setTimeout(function() {
                                q(t)
                            }, 10 * e)
                        }(t[H], H)
                        ...
                        i = function(e) {
                            ...
                            for (a in e)
                                if (e.hasOwnProperty(a))
                                    if (u = e[a], n(u))
                                        for (H = 0; H < u.length; H++) c += o(a + i, u[H]);
                                    else c += o(a + i, u);
                            return c
                        };
                    return {
                        ...
                        build: function(t) {
                            ...
                            for (a.push(e), H = 0; H < a.length; H++) a[H] = a[H].slice(1);
                            return a
                        }
                    }
                }
                ...
                var U, z, $, R, F, Z, H, V = {
                    ...
                    W = K.decodeURIComponent,
                    X = "https:" === Y.location.protocol,
                    te = b(Y.domain, K.location.href, Y.referrer),
                    ee = te[0],
                    ne = (te[1], te[2]),
                    re = K.location.pathname + K.location.hash,
                    ae = "heap-event-visualizer",
                    oe = "_hp_ved",
                    ie = E("heapanalytics.com/js/ved.js"),
                    ue = E("heapanalytics.com/css/ved.css"),
                    ce = E("heapanalytics.com/h"),
                    fe = E("heapanalytics.com/api/identify"),
                    pe = "_hp2_",
                    se = 63072e6,
                    le = 18e5,
                    he = 1024,
                ...
                var Oe = [].indexOf || function(t) {
                    ...
                    Te = function() {
                        var e = [],
                            ...
                            s = function(t) {
                                var e, n, r, a;
                                for (n = ""; t && "BODY" !== t.tagName && "HTML" !== t.tagName && (e = "@" + t.tagName.toLowerCase() + ";", a = i(t, "id"), a && (e += "#" + a.replace(/\s/g, "") + ";"), r = o(t), r && (e += "." + r.split(/\s+/).sort().join(";.") + ";"), e += "|", !(n.length + e.length > he));) n = e + n, t = t.parentElement;
                                return n
                            },
                            l = function(e) {
                                var n, r, u, f;
                ...
                if (K.heap || (K.heap = []), !heap.userid) {
                    ...
                    if (K.heap = {
                            ...
                            identify: function(t) {
                                var n, r, a, o, i, u;
                                if (!Se) return void ke.push(["identify", t]);
                                if (r = {}, n = A(), i = ["handle", "email"], e(t)) {
                                    for (o in t) t.hasOwnProperty(o) && (e(t[o]) || (u = d(t[o], de), Oe.call(i, o) >= 0 ? r[o.charAt(0)] = u : r[d(o, de)] = u));
                        ...
                        var Je = function() {
                            for (var t = Y.getElementsByTagName("*"), e = 0; e < t.length; e++) {
                                ...
                                if (1 === n.nodeType && !n._hpseen) {
                                    ...
                                    for (var r = 0; r < be.length; r++) u(n, be[r], I)
                                }
                            }
                            setTimeout(Je, ye)
                        };
                        ...
                        for (u(K, "click", h, !0), H = 0; H < be.length; H++) u(K, be[H], I, !0);
